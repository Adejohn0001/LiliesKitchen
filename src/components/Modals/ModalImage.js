    ...
    <div className="modal2" onClick={props.onClose}>
      <div className="modal-content2 " onClick={e => e.stopPropagation()}>
        <div className="modal-body2">
          <div>
            <img src={burgers} alt="icon" />
          </div>
          <div>
            <p className="p">Cheeseburger</p>
          </div>
          <div>
            <p className="p2">
          ...
          <div className="price-minutes-pieces">
            <div className="price"><p>NGN 1000.00</p></div>
            <div className="minutes"><p>10-20 Mins</p></div>
            <div className="avail"><p>10 Pcs Avail</p></div>
          </div>
          ...
          <div className="btns">
            <div className="in-de-btn">
              ...
              <button className="add-btn2" onClick={increment}>+</button>
            </div>
